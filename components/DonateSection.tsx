    ...
    <div className="py-4">
      <div className="mx-auto max-w-3xl">
        <div className="mb-8 text-center">
          <h2 className="text-3xl font-extrabold text-slate-900">🚩 Online <span className="text-orange-600">Chanda / Contribution</span></h2>
            ...
            {showQrCode && (
              <div className="mt-5 border-t border-orange-100 pt-5 text-center">
                ...
                <div className="inline-block rounded-xl bg-white p-3 shadow-inner ring-1 ring-orange-100">
                  <QRCodeSVG value={upiPaymentLink} size={200} bgColor="#ffffff" fgColor="#1e1b4b" level="H" includeMargin={false} />
                </div>
          ...
          <div>
            ...
            {screenshotPreview ? (
              <div className="mt-2 relative inline-block">
                ...
                <button type="button" onClick={removeScreenshot} aria-label="Remove screenshot"
