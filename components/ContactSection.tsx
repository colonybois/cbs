        ...
        <div>
          ...
          <div className="mt-3 flex gap-3">
            <a
              ...
              className="flex flex-1 flex-col items-center gap-2 rounded-xl bg-white px-3 py-3.5 text-[#E1306C] ring-1 ring-[#e8e0d4] transition hover:ring-[#E1306C]/35"
            >
              <span
            ...
            <a
              ...
              className="flex flex-1 flex-col items-center gap-2 rounded-xl bg-white px-3 py-3.5 text-[#25D366] ring-1 ring-[#e8e0d4] transition hover:ring-[#25D366]/40"
            >
            ...
            >
              <span className="grid h-11 w-11 place-items-center rounded-full bg-navy text-white shadow-sm">
                <EmailMark />
              </span>
