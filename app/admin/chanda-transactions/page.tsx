...
type Transaction = { id: string; residentName?: string; phone?: string; amount?: number; transactionId?: string | null; message?: string | null; paymentMethod?: string; status?: "pending" | "approved" | "rejected"; createdAt?: TimestampLike; verifiedAt?: TimestampLike; verifiedBy?: string };
