...
export default function Dashboard() {
  ...
  return <div className="space-y-7">
    <div className="flex flex-wrap items-start justify-between gap-3"><WelcomeBanner title="Admin overview" text={loading ? "Loading live collection data..." : "Live figures from your Colony Bois Firebase data."}/>{role === "super_admin" && <Link href="/admin/super-dashboard" className="rounded-xl border border-amber-300 bg-amber-50 px-4 py-2 text-sm font-bold text-amber-800 hover:bg-amber-100">👑 Open Super Admin Dashboard</Link>}</div>
